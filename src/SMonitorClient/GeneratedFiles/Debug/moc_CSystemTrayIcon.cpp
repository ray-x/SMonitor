...
QT_MOC_LITERAL(12, 153, 6),
QT_MOC_LITERAL(13, 160, 15)
    },
    "CSystemTrayIcon\0trayIconStateChanged\0"
    "\0state\0quitApplication\0hideOrShowWidget\0"
    "setState\0SMonitor::Type\0setHidden\0"
    "hidden\0selfUpgrade\0downloadFileErrorOccur\0"
    "errMsg\0downloadSuccess"
};
...
void CSystemTrayIcon::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->hideOrShowWidget(); break;
        case 3: _t->setState((*reinterpret_cast< SMonitor::Type(*)>(_a[1]))); break;
        case 4: _t->setHidden((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 5: _t->selfUpgrade(); break;
        case 6: _t->downloadFileErrorOccur((*reinterpret_cast< const QString(*)>(_a[1]))); break;
