...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CPushButton_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 27, 3)
    ...
    "CPushButton\0setTipsNumber\0\0num"
};
...
void CPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->setTipsNumber((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject CPushButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_CPushButton.data,
      qt_meta_data_CPushButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CPushButton.stringdata))
