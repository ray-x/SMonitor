	...
	: QWidget(parent)
{
	...
	NEW_TOOLBUTTON(m_maximumBtn, ":/Resources/maxi", QString::fromLocal8Bit("最小化"))
	...
	connect(m_maximumBtn, &QToolButton::clicked, this, &CTitleWidget::maximumzed);
	...
	titleLayout->addWidget(m_maximumBtn, 0, Qt::AlignRight);
