/****************************************************************************
** Meta object code from reading C++ file 'CStatusWidget.h'
**
...
#error "The header file 'CStatusWidget.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CStatusWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 40, 17)
    ...
    "CStatusWidget\0changePasswd\0\0checkLength\0"
    "distributeMessage"
};
...
void CStatusWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->changePasswd(); break;
        case 1: _t->checkLength(); break;
        case 2: _t->distributeMessage(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject CStatusWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CStatusWidget.data,
      qt_meta_data_CStatusWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CStatusWidget.stringdata))
        return static_cast<void*>(const_cast< CStatusWidget*>(this));
    if (!strcmp(_clname, "Ui::CStatusWidget"))
        return static_cast< Ui::CStatusWidget*>(const_cast< CStatusWidget*>(this));
