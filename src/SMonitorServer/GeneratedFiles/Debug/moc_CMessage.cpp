...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CMessage_t, stringdata) + ofs \
...
const QMetaObject CMessage::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CMessage.data,
      qt_meta_data_CMessage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CMessage.stringdata))
